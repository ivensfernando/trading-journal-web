...
export var useCanAccess = function (params) {
    ...
    var queryResult = useQuery(__assign({ queryKey: ['auth', 'canAccess', __assign(__assign({}, params), { record: record, resource: resource })], queryFn: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
