...
var useUpdateMany = function (resource, params, options) {
    ...
    var mutateWithMiddlewares = (0, react_1.useRef)(dataProvider.updateMany);
    ...
    var updateCache = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var updatedAt, clonedData, updateColl;
        var resource = _b.resource, ids = _b.ids, data = _b.data, meta = _b.meta;
                ...
                switch (_e.label) {
                    case 0:
                        ...
                        if (getMutateWithMiddlewares) {
                            mutateWithMiddlewares.current = getMutateWithMiddlewares(dataProvider.updateMany.bind(dataProvider));
                        }
                        else {
                        ...
                        if (mode.current === 'pessimistic') {
                            if (returnPromise) {
                                return [2 /*return*/, mutation.mutateAsync(__assign({ resource: callTimeResource }, callTimeParams), otherCallTimeOptions)];
                            }
    ...
    return [(0, util_1.useEvent)(updateMany), mutationResult];
};
