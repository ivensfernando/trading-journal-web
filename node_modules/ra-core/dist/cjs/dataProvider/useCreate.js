...
var useCreate = function (resource, params, options) {
    ...
    var addUndoableMutation = (0, undo_1.useAddUndoableMutation)();
    var data = params.data, meta = params.meta;
    ...
    var mutateWithMiddlewares = (0, react_1.useRef)(dataProvider.create);
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        setTimeout(function () {
                            if (onSuccess) {
                                onSuccess(callTimeData, __assign({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
                            }
                            else if (mutationOptions.onSuccess &&
                                !hasCallTimeOnSuccess.current) {
                                mutationOptions.onSuccess(callTimeData, __assign({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
                            }
                        }, 0);
                                ...
                                if (isUndo) {
                                    ...
                                    queryClient.removeQueries({
                                        queryKey: [
                                            callTimeResource,
                                            'getOne',
                                            { id: String(callTimeId), meta: meta },
                                        ],
                                        exact: true,
                                    });
    ...
    return [(0, util_1.useEvent)(create), mutationResult];
};
