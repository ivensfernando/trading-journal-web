...
export interface UseReferenceOneFieldControllerParams<RecordType extends RaRecord = any, ErrorType = Error> {
    record?: RaRecord;
    reference: string;
    source?: string;
    target: string;
 ...
 */
export declare const useReferenceOneFieldController: <RecordType extends RaRecord = any, ErrorType = Error>(props: UseReferenceOneFieldControllerParams<RecordType, ErrorType>) => UseReferenceResult<RecordType, ErrorType>;
