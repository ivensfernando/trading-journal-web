 ...
 */
export declare const ReferenceFieldBase: <ReferenceRecordType extends RaRecord = RaRecord>(props: ReferenceFieldBaseProps<ReferenceRecordType>) => React.JSX.Element;
export interface ReferenceFieldBaseProps<ReferenceRecordType extends RaRecord = RaRecord> {
    children?: ReactNode;
    className?: string;
    error?: ReactNode;
    queryOptions?: Partial<UseQueryOptions<ReferenceRecordType[], Error> & {
        meta?: any;
    }>;
    reference: string;
    source: string;
}
//# sourceMappingURL=ReferenceFieldBase.d.ts.map