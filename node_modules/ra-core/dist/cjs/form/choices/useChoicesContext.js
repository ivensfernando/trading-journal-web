    ...
    var result = (0, react_1.useMemo)(function () {
        ...
        if (options.choices || !context) {
            return {
                ...
                isLoading: (_j = list.isLoading) !== null && _j !== void 0 ? _j : false, // we must take the one for useList, otherwise the loading state isn't synchronized with the data
                isPending: (_k = list.isPending) !== null && _k !== void 0 ? _k : false, // same
                isFetching: (_l = list.isFetching) !== null && _l !== void 0 ? _l : false, // same
