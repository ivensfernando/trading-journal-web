...
var FilterLiveForm = function (props) {
    ...
    var finalResolver = resolver
        ...
        : validate
            ...
            : undefined;
    var formContext = (0, react_hook_form_1.useForm)(__assign({ mode: 'onChange', resolver: finalResolver }, rest));
        ...
        var unsubscribe = watch(function (values, _a) {
            ...
            if (name) {
                if ((0, get_1.default)(values, name) === '') {
                    ...
                    (0, set_1.default)(newValues, name, '');
...
var mergeObjNotArray = function (a, b) {
    return (0, mergeWith_1.default)((0, cloneDeep_1.default)(a), b, mergeCustomizer);
};
/**
